...
import com.smartaccounting.repository.AuditLogRepository;
...
class AcceptanceCriteriaIT extends AbstractPostgresSpringBootIntegrationTest {
    ...
    void auditCompletenessCoversDashboardAiAndActionFlows() throws Exception {
        ...
        assertTrue(actions.contains("AI_COPILOT_QUERY"));
