...
@SpringBootTest(properties = {
    ...
    "smartaccounting.kafka.topic-dlq-events=domain.events.dlq"
})
@Testcontainers(disabledWithoutDocker = true)
class KafkaPipelineIT extends AbstractPostgresSpringBootIntegrationTest {
    ...
    void kafkaPublisherSendsTenantKeyedEvent() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "smartaccounting-kafka-it");
