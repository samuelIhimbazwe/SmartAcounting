-- Idempotent repair: (re)create auth_* scalar helpers required by PublicAuthSqlLookup.
-- Fixes managed Postgres where app code was deployed before V99 ran successfully.
