-- SECURITY DEFINER alone does not bypass RLS for the table owner on managed Postgres.
-- Public signup/login helpers must disable row_security for cross-tenant lookups.
