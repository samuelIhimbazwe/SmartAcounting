...
public class DomainEventConsumer {
    ...
    public DomainEventConsumer(IncrementalProjectionService projectionService,
                               ...
                               @Value("${smartaccounting.kafka.topic-dlq-events:domain.events.dlq}") String dlqTopic) {
    ...
    @KafkaListener(topics = "${smartaccounting.kafka.topic-domain-events:domain.events}")
