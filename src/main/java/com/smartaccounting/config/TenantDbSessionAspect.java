...
public class TenantDbSessionAspect {
    ...
    public void setTenantContextForTransaction() {
        // Depending on advice ordering, synchronization may be active before the physical transaction flag flips.
        ...
        try {
            ...
            // Non-Postgres test databases (H2) may not support set_config; allow graceful fallback.
        }
    }
}
