...
import com.smartaccounting.dto.CreateDocumentRequest;
...
public class DocumentService {
    ...
    public DocumentService(JdbcTemplate jdbcTemplate,
                           @Value("${smartaccounting.documents.provider:s3}") String storageProvider,
                           @Value("${smartaccounting.documents.bucket:smartaccounting-docs}") String storageBucket) {
