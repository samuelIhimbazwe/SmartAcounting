...
import com.smartaccounting.repository.WebhookDeliveryLogRepository;
...
public class WebhookDispatchService {
    ...
    public void dispatch(String eventType, Map<String, Object> payload) {
        ...
        for (WebhookSubscription sub : subscriptions) {
            ...
            try {
                ...
                headers.set("X-SmartAccounting-Signature", signature);
    ...
    @Scheduled(fixedDelayString = "${smartaccounting.webhook.retry-delay-ms:30000}")
