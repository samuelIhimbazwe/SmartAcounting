...
public class JwtService {
    ...
    public JwtService(@Value("${smartaccounting.security.jwt-secret}") String secret,
                      @Value("${smartaccounting.security.jwt-key-id:smartaccounting-k1}") String currentKid,
                      @Value("${smartaccounting.security.jwt-legacy-secrets:}") String legacySecrets,
                      @Value("${smartaccounting.security.jwt-secret-file:}") String jwtSecretFile,
                      @Value("${smartaccounting.security.jwt-legacy-secrets-file:}") String jwtLegacySecretsFile,
                      @Value("${smartaccounting.security.jwt-expiration-minutes}") long expirationMinutes) {
