...
public class ApiVersionDeprecationFilter extends OncePerRequestFilter {
    ...
    public ApiVersionDeprecationFilter(@Value("${smartaccounting.api.v1-deprecation-enabled:false}") boolean v1DeprecationEnabled,
                                       @Value("${smartaccounting.api.v1-sunset:Wed, 31 Dec 2026 23:59:59 GMT}") String v1Sunset) {
